        ...
        <div class="row">
			...
			<legend>Manage Promotions.</legend>
			  ...
			  <?php
					...
					$sql = mysql_query("SELECT * FROM promotions order by id DESC")
					or die(mysql_error());  
					$id;
					...
					echo '<td><img src="images/'.$row['image'].'" width="100px"/></td>';
					
				
					
					echo '<td><a class="btn btn-warning" href="delete_promotion.php?id='.$row['id'].'">Delete</a>';
